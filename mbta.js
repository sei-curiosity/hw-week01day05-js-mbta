...
Orange: ['North Station','Haymarket','Park Street','Downtown Crossing','chinatown','Back Bay','Forest Hills']
    ...
    if(startLine !== endLine){
        ...
        return claculateStops(startPoint, endPoint);}}  // Its Twenty-Six lines of codes.    
console.log(stopsBetweenStations('Red','Alewife','Red','Alewife'));   // Output taken Captured " Output.png"  
